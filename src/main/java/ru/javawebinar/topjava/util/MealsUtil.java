...
public class MealsUtil {
    ...
    public static final List<Meal> meals = Arrays.asList(
            ...
            new Meal(LocalDateTime.of(2021, Month.JANUARY, 31, 0, 0), "Еда на граничное значение", 100, 2),
            new Meal(LocalDateTime.of(2021, Month.JANUARY, 31, 10, 0), "Завтрак", 1000, 2),
            new Meal(LocalDateTime.of(2021, Month.JANUARY, 31, 13, 0), "Обед", 500, 2),
            new Meal(LocalDateTime.of(2021, Month.JANUARY, 31, 20, 0), "Ужин", 410, 2)
    );
